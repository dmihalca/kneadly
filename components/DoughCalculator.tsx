...
const breadFlourGrams =
  totalFlour * (breadFlour / blendTotal);

const wholeFlourGrams =
  totalFlour * (wholeFlour / blendTotal);

const wholeGrainGrams =
...
const totalWater =
  totalFlour * HYDRATION;

const finalWater =
  totalWater - bigaWater;

const salt =
  totalFlour * (saltPercent / 100);

const dmp =
  totalFlour * DMP_PERCENT;

const oil =
  totalFlour * (oilPercent / 100);
      ...
      {results && (
        <>
          ...
          <div className="space-y-4">
            ...
            <p>
              Biga flour:{" "}
              {results.bigaFlour.toFixed(1)} g
            </p>

            <p>
              Biga water:{" "}
              {results.bigaWater.toFixed(1)} g
            </p>

            <p>
              Biga yeast:{" "}
              {results.bigaYeast.toFixed(3)} g
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p>
              00 Flour:{" "}
              {results.flour00Grams.toFixed(1)} g
            </p>

            <p>
              Bread Flour:{" "}
              {results.breadFlourGrams.toFixed(1)} g
            </p>

            <p>
              Whole Wheat:{" "}
              {results.wholeFlourGrams.toFixed(1)} g
            </p>

            <p>
              Whole Grain:{" "}
              {results.wholeGrainGrams.toFixed(1)} g
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p>
              Total dough weight:{" "}
              {results.totalDoughWeight.toFixed(1)} g
            </p>
          ...
          <div className="space-y-4">
            ...
            <p>
              Final flour:{" "}
              {results.finalFlour.toFixed(1)} g
            </p>

            <p>
              Final water:{" "}
              {results.finalWater.toFixed(1)} g
            </p>

            <p>
              Salt:{" "}
              {results.salt.toFixed(1)} g
            </p>

            <p>
              Diastatic Malt Powder:{" "}
              {results.dmp.toFixed(1)} g
            </p>

            <p>
              Olive oil:{" "}
              {results.oil.toFixed(1)} g
            </p>
          </div>
        </>
      )}
