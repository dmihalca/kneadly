...
export default function DoughCalculator() {
  ...
  const calculateAll = () => {
    ...
    const breadFlourGrams = roundGrams(
      totalFlour * (breadFlour / blendTotal)
    );

    const wholeFlourGrams = roundGrams(
      totalFlour * (wholeFlour / blendTotal)
    );

    const wholeGrainGrams = roundGrams(
    ...
    const remainingWater = roundGrams(
      totalWater - bigaWater
    );

    const salt = roundGrams(
          ...
          {results && (
            <>
              ...
              <div className="space-y-4">
                ...
                <p>
                  00 Flour:{" "}
                  {results.flour00Grams} g
                </p>

                <p>
                  Bread Flour:{" "}
                  {results.breadFlourGrams} g
                </p>

                <p>
                  Whole Wheat:{" "}
                  {results.wholeFlourGrams} g
                </p>

                <p>
                  Whole Grain:{" "}
                  {results.wholeGrainGrams} g
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <p>
                  Remaining flour:{" "}
                  {results.remainingFlour} g
                </p>

                <p>
                  Remaining water:{" "}
                  {results.remainingWater} g
                </p>
